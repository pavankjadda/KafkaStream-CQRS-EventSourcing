...
public class Greetings extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord
{
	...
	@Deprecated
	public java.lang.CharSequence timestamp;
	@Deprecated
	 ...
	 */
	public static Greetings.Builder newBuilder()
	{
		return new Greetings.Builder();
	}
	 ...
	 * @return A new Greetings RecordBuilder
	 */
	public static Greetings.Builder newBuilder(Greetings.Builder other)
	{
		if (other == null)
		{
			return new Greetings.Builder();
		...
		{
			return new Greetings.Builder(other);
		}
	}
	 ...
	 * @return A new Greetings RecordBuilder
	 */
	public static Greetings.Builder newBuilder(Greetings other)
	{
		if (other == null)
		{
			return new Greetings.Builder();
			...
			implements org.apache.avro.data.RecordBuilder<Greetings>
	{
		 ...
		 * @param other The existing Builder to copy.
		 */
		private Builder(Greetings.Builder other)
		{
			super(other);
		 ...
		 * @param other The existing instance to copy.
		 */
		private Builder(Greetings other)
		{
			super(SCHEMA$);
			if (isValidValue(fields()[0], other.timestamp))
			{
		 ...
		 * @return This builder.
		 */
		public Greetings.Builder setTimestamp(java.lang.CharSequence value)
		{
		 ...
		 * @return This builder.
		 */
		public Greetings.Builder clearTimestamp()
		{
			timestamp = null;
		 ...
		 * @return This builder.
		 */
		public Greetings.Builder setMessage(java.lang.CharSequence value)
		{
		 ...
		 * @return This builder.
		 */
		public Greetings.Builder clearMessage()
		{
			message = null;
