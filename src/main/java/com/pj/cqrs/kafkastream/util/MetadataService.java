...
public class MetadataService
{
	...
	private List<HostStoreInfo> mapInstancesToHostStoreInfo(final Collection<StreamsMetadata> streamsMetadataCollection)
	{
		return streamsMetadataCollection.stream().map(metadata -> new HostStoreInfo(metadata.host(), metadata.port(), metadata.stateStoreNames())).collect(Collectors.toList());
	}
